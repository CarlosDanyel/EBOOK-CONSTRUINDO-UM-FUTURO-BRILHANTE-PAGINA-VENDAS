            ...
            <header>
                ...
                <div className={style.containerHeader}>
                    ...
                    <nav
                        className={
                            active
                                ? `${style.navegacaoMenu} ${style.active} ${style.menu}`
                                : style.navegacaoMenu
                        }
                    >
                        <BtnNavbar active={active} onClick={activeMode} />
            ...
            <main>
                <section name="Home" className={style.home}>
                    <div className={style.displayHome}>
                        <div className={style.home_texts}>
                            <h1>
                                Construido um futuro <br /> brilhante{" "}
                                <span className={style.textLine}> Ebook</span>
                            </h1>
                            <p>
                                Recurso indispensável para pais e filhos que
                                desejam se preparar adequadamente para a
                                iniciação ao primeiro emprego.
                            </p>
                        ...
                        <div className={style.home_imgs}>
                            ...
                            <img
                                className={style.home_imgs_cover}
                                src={imgJovem}
                                alt="Jovem no mercado de trabalho"
                            />
                        </div>
                    </div>
                </section>
                ...
                <section name="Vantagens" className={style.vantagens}>
                    <div className={style.vantagensContainer}>
                        <span className={style.vantagensTitle}>
                            Vantagens imperdíveis
                        </span>
                        <button>
                            <Link to={"Compra"} smooth={true} duration={800}>
                                Inicie Já
                            </Link>
                        </button>
                    </div>
                ...
                <section name="Provas" className={style.prova}>
                    <div className={style.display}>
                        ...
                        <p className={style.descricao}>
                            Depoimentos reais de pessoas que se beneficiaram do
                            eBook Conquiste o Seu Primeiro Emprego.
                        </p>
                        <ListaDeProvas />
                    </div>
                </section>
                <section name="Sobre" className={style.sobre}>
                    <div className={style.displaySobre}>
                        <div className={style.sobreText}>
                            ...
                            <p>
                                Nosso produto é um recurso indispensável e
                                completo para pais e filhos que buscam uma
                                preparação sólida e adequada para a iniciação ao
                                primeiro emprego e ao mercado de trabalho.
                            </p>
                            <p>
                                {" "}
                                Com a crescente competitividade no mercado de
                                trabalho, é fundamental que jovens estejam bem
                                preparados para dar seus primeiros passos no
                                mundo profissional. Nosso produto oferece uma
                                abordagem abrangente que engloba todas as etapas
                                do processo de busca pelo primeiro emprego e
                                rumo profissional.
                            </p>
                        </div>
                        <div className={style.sobreImg}>
                            <img
                                className={style.sobreImgContent}
                                src={imgSobre}
                                alt="Sobre nossa pagina"
                            />
                            <img
                                className={style.take1}
                                src={teck1}
                                alt="E-book: Construindo um futuro brilhante."
                            />
                            <img
                                className={style.take2}
                                src={teck2}
                                alt="Produtos em promoção."
                            />
                            <img
                                className={style.take3}
                                src={teck3}
                                alt="Voce no mercado de trabalho."
                            />
                            <img
                                className={style.take4}
                                src={teck4}
                                alt="Compra segura."
                            />
                        </div>
                ...
                <section name="Compra" className={style.compra}>
                    <div className={style.displayCompra}>
                        <div className={style.bnc_text}>
                            ...
                            <h5>
                                construindo um futuro <br /> brilhante!
                            </h5>
                            ...
                            <div className={style.listaBn}>
                                <div className={style.listaBn1}>
                                    <span>
                                        <Verificado /> Inclusos todos os
                                        beneficios{" "}
                                    </span>
                                    <span>
                                        <Verificado /> Acesso vitalicio
                                    </span>
                                </div>
                                <div className={style.listaBn2}>
                                    <span>
                                        <Verificado /> Garantia de 7 dias após a
                                        compra
                                    </span>
                                    <span>
                                        <Verificado /> Sua Compra segura{" "}
                                    </span>
                                </div>
                            </div>
                            <div className={style.slBtn}>
                                <a href="#">
                                    <button className={style.btnCompra}>
                                        Garanta ja o seu!
                                    </button>
                                </a>
                        ...
                        <div className={style.compraImg}>
                            <img
                                src={PrecoPng}
                                alt="Construindo um futuro brilhante preço"
                            />
                        </div>
                    </div>
                </section>
                ...
                <div className={style.display}>
                    ...
                    <div className={style.termos}>
                        <p>
                            ...
                            <span>@contruindoUmFuturo.com.br</span>
                        </p>
                    </div>
                </div>
            </footer>
